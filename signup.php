<?php
    ...
    */
    ...
    if($_POST["confirmPassword"]!=$_POST["password"]){
        ...
        $user_id = $result ++;
        $mysqli->query("INSERT INTO cse442_2024_fall_team_ak_db.ACCOUNTS(USER_ID, FIRST_NAME, LAST_NAME, EMAIL, PASSWORD, NICKNAME, COUNTRY, TIMEZONE, GENDER, LANG VALUES('$user_id', '$firstName', '$lastName', '$email', '$password', '$nickname', '$country', '$timezone', '$gender', '$language')");    
    } else {
